use crate::{error::Result, CompilerInput, CompilerOutput, ZkSolc};

/// The result of a `solc` process bundled with its `ZkSolc` and `CompilerInput`
type CompileElement = (Result<CompilerOutput>, ZkSolc, CompilerInput);
