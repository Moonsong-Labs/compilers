...
use crate::artifacts::zksolc::{
    contract::Contract, error::Error, CompilerOutput as ZkCompilerOutput,
};
...
use foundry_compilers_artifacts::{
    solc::error::SourceLocation, BytecodeObject, Severity, SolcLanguage,
};
